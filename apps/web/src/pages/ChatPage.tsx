        ...
        <header className="h-14 border-b border-border/30 bg-background/40 backdrop-blur-3xl px-10 flex items-center justify-between shrink-0 transition-all duration-500">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-[11px] font-black uppercase tracking-[0.3em] text-secondary-content">
            ...
            <div className="flex items-center gap-2.5 px-3 py-1 rounded-lg bg-muted/20 border border-border/40 hover-glow">
              ...
              <span className="text-[10px] font-black text-secondary-content uppercase tracking-widest leading-none">
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-base font-medium text-secondary-content leading-relaxed">
                  ...
                  <div className="grid gap-4 w-full sm:grid-cols-2">
                    {[
                      ...
                      >
                        <span className="text-[13px] font-bold text-secondary-content group-hover:text-foreground transition-colors">
                          {s.l}
                        </span>
                          ...
                          <div className="w-full rounded-3xl border border-primary/10 bg-primary/[0.01] overflow-hidden p-8 hover-glow transition-all duration-500">
                            <div className="flex items-center justify-between mb-8">
                              <div className="flex items-center gap-4">
                                ...
                                <span className="text-[11px] font-black uppercase tracking-widest text-secondary-content">
                                  Execution Moved
                                </span>
                              </div>
                            ...
                            <div className="grid grid-cols-2 gap-5 mb-8">
                              <div className="rounded-2xl border border-border/40 bg-background/40 p-5 space-y-1">
                                <span className="text-label-sm block">Engine node</span>
                              ...
                              <div className="rounded-2xl border border-border/40 bg-background/40 p-5 space-y-1">
                                <span className="text-label-sm block">Identity node</span>
                                <span className="text-[11px] font-bold text-foreground truncate block uppercase tracking-tight">
          ...
          <div className="max-w-4xl mx-auto space-y-5">
            <div className="relative group transition-all">
              ...
              <div className="relative flex items-end gap-5 rounded-[2.5rem] border border-border/60 bg-background p-4 shadow-inner focus-within:border-primary/20 transition-all duration-500">
                <button className="h-11 w-11 flex-shrink-0 flex items-center justify-center rounded-2xl icon-container">
                ...
                <textarea
                  ...
                  className="flex-1 max-h-96 min-h-[48px] resize-none bg-transparent py-3.5 text-[15px] font-medium outline-none text-placeholder-content leading-relaxed transition-all"
                />
                <div className="flex items-center gap-3 pb-1.5 pr-1.5">
                  <button
                    onClick={refinePrompt}
                    disabled={!input.trim() || isRefining}
                    className="h-11 w-11 flex items-center justify-center rounded-2xl icon-container hover:bg-primary/5 disabled:opacity-0"
                  >
                    {isRefining ? (
                  ...
                  <button
                    ...
                    className="h-11 w-11 flex items-center justify-center rounded-2xl bg-primary text-white shadow-xl shadow-primary/10 hover:opacity-90 active:scale-90 transition-all disabled:opacity-20"
                  >
            ...
            <div className="flex items-center justify-between px-8 text-meta text-muted-content">
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="h-3 w-3" /> Governance
                </div>
                <div className="flex items-center gap-2">
                  <Zap className="h-3 w-3" /> Handoff
                </div>
              </div>
              <span className="font-bold opacity-70 transition-opacity group-focus-within:opacity-100">
                Ready for Dispatch
              </span>
            </div>
          </div>
      ...
      <AnimatePresence>
        {showSystemPanel && (
          <motion.aside
            ...
            className="border-l border-border/30 bg-background/40 backdrop-blur-3xl relative z-30 flex flex-col shadow-2xl"
          >
            ...
            <div className="flex-1 overflow-y-auto p-12 space-y-12 scrollbar-none">
              <div className="space-y-5">
                ...
                <div className="rounded-[2rem] border border-border/40 bg-muted/10 p-8 leading-relaxed text-[15px] font-medium text-secondary-content italic shadow-inner">
                  "
                ...
                <div className="flex flex-wrap gap-2.5">
                  {(currentPersona?.capabilities || ['Logic Trace', 'Context Audit']).map(
                    (cap: string) => (
                      <span
                        key={cap}
                        className="px-4 py-2 rounded-xl bg-background border border-border/60 text-[11px] font-black uppercase tracking-widest text-secondary-content shadow-sm hover-glow"
                      >
                        {cap}
                      </span>
                    )
